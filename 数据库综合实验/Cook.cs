    ...
    public partial class Cook : Form
    {
        ...
        private void 厨师编号ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String find = "SELECT food_name,food_description,food_type,food_suitablemeal,food_carft," +
                    "food_texture FROM Food JOIN Food_Cook ON Food.food_num=Food_Cook.food_num WHERE cook_num='"+num +"'";
                ...
                {
                    MessageBox.Show("查询有误，请重新查询！！！");
                }
                dataGridView1.DataSource = DS.Tables["performtable"];
                cnn.Close();
                dataGridView1.Columns[0].HeaderText = "食物名";
                dataGridView1.Columns[1].HeaderText = "食物特点";
                dataGridView1.Columns[2].HeaderText = "食物类型";
                dataGridView1.Columns[3].HeaderText = "食物适宜时间";
                dataGridView1.Columns[4].HeaderText = "食物工艺";
                dataGridView1.Columns[5].HeaderText = "食物口感";
